...
const Demo = () => {
  //this useState for getting the value form the input field
  const [article, setArticle] = useState({
    url: "",
    summary: "",
  });
  //this useState for getting the value from the local storage

  const [allArticles, setAllArticles] = useState([]);

  //this useState for copy the text
  const [copied, setCopied] = useState("");
  //getsummary is a function
